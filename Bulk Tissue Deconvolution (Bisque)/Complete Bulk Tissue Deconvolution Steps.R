...
bulk.data <- read.delim("/Volumes/Seagate Backup Plus Drive/UROPS/Datasets/Bulk Tissue Data/raw_count.txt")
...
deg.genes <- read.table("/Volumes/Seagate Backup Plus Drive/UROPS/Datasets/DEG Analysis/Unique_DEGs2.csv")

#Replace DEG names with gene IDs.
